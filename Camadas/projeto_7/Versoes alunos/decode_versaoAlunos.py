...
def main():
    tabela_frequencia = [[697, 1209], [697, 1336], [697, 1477], [770, 1209], [770, 1336], [770, 1477], [852, 1209], [852, 1336],
             [852, 1477], [941, 1336]]
...
# analise sua variavel "audio". pode ser um vetor com 1 ou 2 colunas, lista, isso dependerá so seu sistema, drivers etc...
    ...
    frequencias_de_pico = xf[index] #indice das frequencias de pico
    frequencias_desejadas = [] #lista para gravar as listas desejadas
    
    for frequencia_pico in frequencias_de_pico:
        for frequencias in tabela_frequencia:
            for frequencia in frequencias:
                print(f"frequencia de pico {frequencia_pico}, frequencia {frequencia}")
                if frequencia+1 >= frequencia_pico and frequencia-1 <= frequencia_pico: #determinando faixa aceitavel para frequencia de pico
                    print("achou")
